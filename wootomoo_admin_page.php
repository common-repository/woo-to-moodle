...
function wootomoo_admin_page() {
    ...
    if( ! wootomoo_get_courses() ) {
        ...
        <div class="wrap">
            ...
            <br class="clear">
            <?php esc_html_e( 'There is an error accessing Moodle.', 'woo-to-moodle' ) ?><br>
            <a href="options-general.php?page=wootomoo_settings_menu"><?php esc_html_e( 'Click here to check Moodle settings.', 'woo-to-moodle' ) ?></a><br>
