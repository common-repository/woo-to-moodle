<div class="wrap">
    ...
    <h2><?php esc_html_e( 'Automatic registration on Moodle.', 'woo-to-moodle' ) ?></h2>
    <br class="clear">
                    ...
                    <div class="tablenav top">
                        <div class="alignleft actions">
                            <a href="<?php echo
                                ...
                                ?>"><?php esc_html_e( 'Delete', 'woo-to-moodle' ) ?></a>
                        </div>
                        <br class="clear">
                    </div>
                </td>
    ...
    <form action="<?php echo admin_url('edit.php?post_type=product&amp;page=' . WOOTOMOO_LINKS_PAGE . '&amp;fnc=add'); ?>" method="post">
        <select name="produit" required>
            <option value="" disabled selected hidden><?php esc_html_e( 'Choose a product...', 'woo-to-moodle' ) ?></option>
            <?php
            foreach( $wootomoo_products as $product ) {
                ?>
        ...
        <select name="cours" required>
            <option value="" disabled selected hidden><?php esc_html_e( 'Choose a course...', 'woo-to-moodle' ) ?></option>
            <?php
            foreach( $wootomoo_courses as $course ) {
                ?>
        ...
        <input type="submit" value="<?php esc_html_e( 'Add', 'woo-to-moodle' ) ?>">
    </form>
